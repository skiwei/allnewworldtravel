<?php namespace App\AllNewWorld\Libraries;
...
class Helper {
	...
	public static function bannerPhoto($bannerName)
	{
		...
		return 'http://www.sayangholidays.com/images/'.$countryCode.'/banners/'.$imageName;
	}
	...
	public static function thumbnailPhoto($imageName)
	{
		...
		return 'http://www.sayangholidays.com/images/'.$countryCode.'/thumbnails/'.$imageName;
	}
